...
/*
 * The proxy operations — the host-free half: the dispatch matrix, artifact
 * triage, and the refusal family. Everything here is a pure function of its
 * arguments, which is the property the matrix and the triage below rely on:
 * the matrix can be asserted as data, and no test needs a chain.
 */

// ---------------------------------------------------------------------------
// the dispatch matrix, row by row, closed
// ---------------------------------------------------------------------------

describe('the four dispatch rows, asserted as data', () => {
...
// ---------------------------------------------------------------------------
// artifact triage: three outcomes, none silent
// ---------------------------------------------------------------------------
...
describe('proxy-artifact triage', () => {
